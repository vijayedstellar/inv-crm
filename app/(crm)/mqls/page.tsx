...
export default function MQLsPage() {
  ...
  const [promoteModal, setPromoteModal] = useState<typeof MQLS[0] | null>(null);
        ...
        <div className="modal-overlay show" onClick={() => setPromoteModal(null)}>
          <div className="modal" style={{ width: 460 }} onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-footer">
              ...
              <button className="btn btn-success" onClick={() => { showToast("✅ Promoted to SQL! SDR notified."); setPromoteModal(null); }}>Confirm Promotion →</button>
            </div>
          </div>
        </div>
      )}
