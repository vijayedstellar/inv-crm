...
const NAV: NavItem[] = [
  ...
  { href: "/contacts", label: "Contacts", icon: "◯", badge: "284", section: "People" },
  { href: "/leads", label: "Leads", icon: "◎", badge: "142" },
  { href: "/mqls", label: "MQLs", icon: "◉", badge: "67" },
  { href: "/sqls", label: "SQLs", icon: "●", badge: "31" },
  { href: "/opportunities", label: "Opportunities", icon: "◆", badge: "18" },
  { href: "/accounts", label: "Accounts", icon: "🏢", badge: "12", section: "Customers" },
  { href: "/renewals", label: "Renewals", icon: "↻", badge: "7" },
  { href: "/contracts", label: "Contracts", icon: "📋", badge: "4", section: "Commerce" },
  { href: "/revenue", label: "Revenue", icon: "£" },
  { href: "/tasks", label: "Tasks", icon: "✓", badge: "9", section: "Work" },
